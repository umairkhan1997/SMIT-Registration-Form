    ...
    return (
      <div>
        ...
        <div className="container py-5">
          ...
          <div className="row">
            {this.state.webandmobile.map((e, i) => {
              return (
                <div className="col-md-3 allTeacher text-center">
                  <div className="my-3">
                    <img
                      style={{
                        borderRadius: "50%",
