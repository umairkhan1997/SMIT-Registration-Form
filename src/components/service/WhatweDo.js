...
//                         <div className="col-md-3 p-2 d-flex justify-content-center align-items-center">
//                           <p style={{ fontSize: "2em", marginTop: 0 }}>
//                             <i
...
//                           </p>
//                         </div>
//                         <div className="col-md-9 p-3 text-left">
//                           <p style={{ color: "#316DC3", fontWeight: "bolder", fontSize: '1.4em' }}>
//                             {filteredName.proName}
//                           </p>
//                           {/* <p className="text-muted" style={{ marginTop: 0, fontSize: 10 }}>
