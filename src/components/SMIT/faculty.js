          ...
          <div className="text-left pt-3 pb-3">
            ...
            <div className="facultyContent  ml-5 pt-5 p-3 rounded shadow">
              <p>
                ...
                Developer & Architect | Innovation Coach & Mentor I believe that
                technology and software can help elevate the human condition. I
                have spent my life developing global internet-scale applications
                and mentoring others to do the same. Have more than twenty years
                of experience in software architecture, design, development,
          ...
          <div className="text-left pt-3 pb-3">
            ...
            <div className="facultyContent  ml-5 pt-5 p-3 rounded shadow">
              <p>
                ...
                Extensive documented track record of building apps using the
                Java/J2EE platform, MEAN Stack, HTML5 Hybrid mobile apps and
                Android Native apps. I have over 10 years of experience in
