        ...
        return (
            <div>
                ...
                <div className='container-fluid'>
                    <div className='row'>
                        <div className='col-md-3 mt-5'>
                            <h4 style={{ color: "#1371b8", }} className='font-weight-bold'>CATEGORIES</h4>
                            <ul>
                                <li className='text-muted bookCatPoint' onClick={() => this.setState({ catType: '' })}>All Books</li>
                                <li className='text-muted bookCatPoint' onClick={() => this.setState({ catType: 'hazrat' })}>Hazrat Basheer Farooqui</li>
                        ...
                        <div className='col-md-9 py-5 border'>
                            <div className='container '>
                                <div className='row'>
                                    {this.props.bookAllCats.filter(name => { return name.bookAuthor.toLowerCase().indexOf(this.state.catType.toLowerCase()) >= 0 }).map(filteredName => {
                                        return (
                                            <div className='col-md-3 my-3'>
                                                <div className='singleBook'>
