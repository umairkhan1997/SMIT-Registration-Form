      ...
      <div>
        ...
        <div className='container'>
          {/* <div className='row'>
                ...
                <div className='col-md-2'>Currency</div>
                <div className='col-md-2'>IBAN</div>
                <div className='col-md-2'>Account Number</div>
                <div className='col-md-2'>Account Title</div>
                <div className='col-md-2'>Branch Code</div>
            </div> */}
