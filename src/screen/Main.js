                ...
                <ul className="navbar-nav mr-auto" style={{color:' white',fontSize:20}}>
                  ...
                  <li className="nav-item ">
                    <a
                     ...
                     tabindex="-1"
                     aria-disabled="true"
                    style={{color:' black',fontSize:20,backgroundColor:'white',borderRadius:10}}>
                      Donation
                    </a>
                  </li>
                </ul>
...
//                          backgroundRepeat: 'no-repeat'}}
                         pageId={2}>
<div className="container-fluid" style={{backgroundColor:'#aaacab',backgroundImage:img1,height:950}}>
...
<div className="col-md-4" style={{width:100}}>
  ...
  <div>
  <h6 style={{width:300,marginLeft:10,textAlign:'left'}}>A-25, Bahadurabad Chowrangi Karachi, Pakistan</h6>
  <div className='row' style={{marginLeft:10}}>
  <p style={{ fontSize: "1em" }}>
                  <i class="fas fa-phone-alt"></i>
                </p>
 <h6  style={{width:300,marginLeft:10,textAlign:'left'}}>UAN: 111-729-526</h6>
  </div>
  <div className='row' style={{marginLeft:10}}>
  <p style={{ fontSize: "1em" }}>
                  <i class="fas fa-mobile"></i>
                </p>
 <h6  style={{width:300,marginLeft:10,textAlign:'left'}}>CELL: 92-311-1729526</h6>
  </div>
  <div className='row' style={{marginLeft:10}}>
  <p style={{ fontSize: "1em" }}>
                  <i class="fas fa-globe"></i>
                </p>
 <h6  style={{width:300,marginLeft:10,textAlign:'left'}}>(+0092-213) 4130786-90</h6>
  </div>
  </div>
  </div>
</div>
...
<div className="row">
 ...
 <h6  style={{width:300,marginLeft:10,textAlign:'left'}}>NO +1(716)941 7792</h6>
  </div>
  </div>
  </div>
</div>
...
<div className="row">
 ...
 <h6  style={{width:300,marginLeft:10,textAlign:'left'}}>NO (+44)115 970 6256</h6>
  </div>
  </div>
</div>
...
<ScrollSection style={{backgroundImage: 'url(http://www.thepetedesign.com/demos/back-phone.png)',
                         backgroundRepeat: 'no-repeat'}}
                         pageId={4}>
<div className="container-fluid" style={{height:500,backgroundColor:'#292825'}}>
