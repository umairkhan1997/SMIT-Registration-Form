              ...
              <div className="col-md-12 py-4">
                ...
                <div className="row">
                  <div className="col-md-3">
                    <label>
                      <input name="qualification" type="radio" /> None
                    </label>
                  </div>
                  <div className="col-md-3">
                    <label>
                      <input name="qualification" type="radio" /> Matric
                    </label>
                  </div>
                  <div className="col-md-3">
                    <label>
                      <input name="qualification" type="radio" /> Entermediate
                    </label>
                  </div>
                  <div className="col-md-3">
                    <label>
                      <input name="qualification" type="radio" /> Graduate
                    </label>
                  </div>
                  <div className="col-md-3">
                    <label>
                      <input name="qualification" type="radio" /> Undergraduate
                    </label>
                  </div>
                  <div className="col-md-3">
                    <label>
                      <input name="qualification" type="radio" /> Masters
                    </label>
                  </div>
                  <div className="col-md-3">
                    <label>
                      <input name="qualification" type="radio" /> PHD
                    </label>
                  </div>
                </div>
              </div>
