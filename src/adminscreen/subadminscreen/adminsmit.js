      ...
      <div>
        <div className="row">
          <div className="col-md-3 bg-light text-primary shadow p-5">
            ...
            <div className="p-4">
              <ul className='list'>
                <li onClick={() => this.setState({ faculty: true, courses: false, numbeOfStudent: false, events: false, teachers: false })}>Faculty</li>
                <li onClick={() => this.setState({ faculty: false, courses: true, numbeOfStudent: false, events: false, teachers: false })}>Cources</li>
                <li onClick={() => this.setState({ faculty: false, courses: false, numbeOfStudent: true, events: false, teachers: false })}>Number of Students</li>
                <li onClick={() => this.setState({ faculty: false, courses: false, numbeOfStudent: false, events: true, teachers: false })}>Events</li>
                <li onClick={() => this.setState({ faculty: false, courses: false, numbeOfStudent: false, events: false, teachers: true })}>Teachers</li>
              </ul>
            </div>
          </div>
          <div
