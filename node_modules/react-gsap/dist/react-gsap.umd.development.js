(function (global, factory) {
  ...
  var Timeline = /*#__PURE__*/function (_Provider) {
    ...
    _proto.cloneElement = function cloneElement(child) {
      // @ts-ignore
      return React__default.cloneElement(child, getRefProp(child, this.addTarget));
    };
    ...
    _proto.renderTarget = function renderTarget(target) {
      ...
      if (reactIs.isForwardRef(target)) {
        // @ts-ignore
        return React__default.cloneElement(target, getTargetRefProp(target, this.setTarget));
